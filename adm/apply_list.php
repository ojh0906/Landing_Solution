                    ...
                    <div class="row mx-0 mb-2">
                        ...
                        <div class="col-6 col-md-2 my-1 my-md-0 px-1">
                            <select class="custom-select custom-select-sm rounded-0" name="sch_c_result">
                                ...
                                <option value="A등급" <? if($sch_c_result == "A등급") echo "selected" ?> >A등급</option>
                                <option value="B등급" <? if($sch_c_result == "B등급") echo "selected" ?> >B등급</option>
                                <option value="부재" <? if($sch_c_result == "부재") echo "selected" ?> >부재</option>
                                <option value="결번" <? if($sch_c_result == "결번") echo "selected" ?> >결번</option>
                                <option value="재통화" <? if($sch_c_result == "재통화") echo "selected" ?> >재통화</option>
                                <option value="결제" <? if($sch_c_result == "결제") echo "selected" ?> >결제</option>
                        ...
                        <table class="table border-bottom border-top" style="min-width: 1850px;">
                            ...
                            ?>
                                <tr class="bg0">
                                    ...
                                    <td>
                                        <select class="custom-select custom-select-sm" onchange="changeResult('<?=$list_row['id']?>', this.value)">
                                            <option value="대기" <? if($list_row['result_status'] == "대기") echo "selected"?>>대기</option>
                                            <option value="A등급" <? if($list_row['result_status'] == "A등급") echo "selected"?>>A등급</option>
                                            <option value="B등급" <? if($list_row['result_status'] == "B등급") echo "selected"?>>B등급</option>
                                            <option value="부재" <? if($list_row['result_status'] == "부재") echo "selected"?>>부재</option>
                                            <option value="결번" <? if($list_row['result_status'] == "결번") echo "selected"?>>결번</option>
                                            <option value="재통화" <? if($list_row['result_status'] == "재통화") echo "selected"?>>재통화</option>
                                            <option value="결제" <? if($list_row['result_status'] == "결제") echo "selected"?>>결제</option>
                                    ...
                                    <td>
                                        <select class="custom-select custom-select-sm" onchange="changeManager('2630', this.value)">
                                            <option value="admin">관리자(admin)</option>
                                        </select>
                                    </td>
...
function changeResult(index, result){

        $.ajax({
            type:'post',
            dataType:'json',
            url:'./apply_list.php',
            data:{wr_id:index, result:result},
